				...
				function readFile() {
					...
					for(var i = 0; i < iLen; i++) {
						...
						reader.onload = function(e) {
							...
							result = '<div class="showdiv"><img class="left" src="resource/images/Arrow_left.svg" /><img class="center" src="resource/images/delete.svg" /><img class="right" src="resource/images/Arrow_right.svg" /></div><img id="img' +currentReViewImgIndex+randomString(1)+randomString(2) +randomString(5) + '" class="showimg" src="' + this.result + '" />';
